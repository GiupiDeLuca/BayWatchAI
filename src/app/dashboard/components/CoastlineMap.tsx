  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        <span className={styles.headerTitle}>ZONE MAP</span>
        <span className={styles.headerSub}>LA/OC Coast</span>
      </div>
      <svg
        viewBox="0 0 600 500"
      ...
      >
        <defs>
          ...
          <pattern id="wavePattern" x="0" y="0" width="60" height="20" patternUnits="userSpaceOnUse">
            <path d="M0 10 Q15 5 30 10 Q45 15 60 10" fill="none" stroke="#9cc8e0" strokeWidth="0.5" opacity="0.4" />
          </pattern>
        </defs>
        ...
        {Array.from({ length: 10 }).map((_, i) => (
          <line key={`h${i}`} x1="0" y1={i * 50} x2="600" y2={i * 50} stroke="#a8c8dd" strokeWidth="0.3" />
        ))}
        {Array.from({ length: 12 }).map((_, i) => (
          <line key={`v${i}`} x1={i * 50} y1="0" x2={i * 50} y2="500" stroke="#a8c8dd" strokeWidth="0.3" />
        ))}
        ...
        <path
          ...
          opacity="0.5"
        />
        <text x="145" y="125" fill="#b8a888" fontSize="8" fontFamily="var(--font-mono)">PCH</text>
        ...
        {zones.map((zone) => {
          ...
          return (
            ...
            >
              ...
              {isSelected && (
                <circle cx={x} cy={y} r="22" fill="none" stroke="var(--color-text)" strokeWidth="1.5" opacity="0.4" />
              )}
              ...
              <circle
                ...
                stroke="#fff"
                strokeWidth="2"
                opacity={zone.streamOnline ? 1 : 0.5}
              />
        ...
        <text x="15" y="490" fill="#a8c8dd" fontSize="9" fontFamily="var(--font-mono)">
          BAYWATCH AI // COASTAL SURVEILLANCE
        </text>
        <text x="15" y="20" fill="#88b0cc" fontSize="7" fontFamily="var(--font-mono)">
          PACIFIC OCEAN
        </text>
      </svg>
